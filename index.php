					  ...
					  <ul class="nav-lang">
                        ...
                        <div class="menu-container">
                            <ul class="nav navbar-nav navbar-nav-right">
                                ...
                                <li class="js_nav-item nav-item"><a class="nav-item-child nav-item-hover" href="#pricing">Compétences</a></li>
                    ...
                    <div class="container">
                        <div class="carousel-centered">
                            <div class="margin-b-40">
                                <h1 class="carousel-title">Je suis Tarek-Aziz<br>ALASSANI</h1>
        ...
        <div id="products">
            <div class="content-lg container">
                <div class="row margin-b-40">
                    <div class="col-sm-6">
                        <h2> PROJETS</h2>
                        <p>Différents projets m'ont permis de monter mes compétences dans les technologies de développement web ainsi que mobile</p>
                    </div>
                </div>
                <!-- -->
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 sm-margin-b-50">
                        ...
                        <h4><a href="#">SONOMETRE</a> <span class="text-uppercase margin-l-20"></span></h4>
                        <p></p>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4 sm-margin-b-30">
                            ...
                            <div class="pricing pricing-active">
                                ...
                                <ul class="list-unstyled pricing-list margin-b-50">
                                    ...
                                    <li class="pricing-list-item"> <B>Androïd</B></li>
                                </ul>                
                            </div>
                            <!-- End Pricing -->
                        </div>
